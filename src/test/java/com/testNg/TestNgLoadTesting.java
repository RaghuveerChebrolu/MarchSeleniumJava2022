...
public class TestNgLoadTesting {
	...
	public void test1() {
		...
		System.out.println(timstamp + " [Thread-" + Thread.currentThread().getId() + " test 1 is executed");
	}
	...
	public void testGoogleSearch() {
		...
		driver.quit();//close all the instances of browsers that are currently active/open
	}
}
